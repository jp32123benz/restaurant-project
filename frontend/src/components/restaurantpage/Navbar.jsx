                    ...
                    <div className={`collapse navbar-collapse ${NavbarToggler ? 'show' : ''}`} id="navbarSupportedContent">
                        <ul className="navbar-nav ms-auto mb-2 mb-lg-0">
                            <li className="nav-item">
                                <Link className="nav-link active fs-5" onClick={handleNavbarShow} to="/dashboard/create-food">add Food</Link>
                            </li>
                            <li className="nav-item">
                                <Link className="nav-link fs-5" onClick={handleNavbarShow} to="/dashboard/food-list">Inventory</Link>
                            </li>
                            <li className="nav-item dropdown">
                                <Link className="nav-link fs-5" onClick={handleNavbarShow} to="/dashboard/order">Order</Link>
                            </li>
                            <li className="nav-item">
                                <Link className="nav-link fs-5" onClick={handleNavbarShow} to="/dashboard/staff-list">Staff</Link>
                            </li>
                            {/* <li className="nav-item">
                                <Link className="nav-link fs-5">Remove Staff</Link>
                            </li> */}
                        </ul>
                    </div>
                </div>
